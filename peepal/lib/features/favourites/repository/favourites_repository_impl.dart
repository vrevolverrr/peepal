...
import 'package:peepal/shared/location/model/mock_location.dart'; // Import the mock location class

class FavouritesRepositoryImpl implements FavouritesRespository {
  final List<PPToilet> _mockToilets = [
    PPToilet(
      ...
      crowdStatus: PPToiletCrowdStatus(crowdLevel: PPToiletCrowdLevel.empty, estimatedWaitTime: 0, estimatedCrowdSize: 0),
    ),
    PPToilet(
      id: 2,
      name: 'Toilet 2',
