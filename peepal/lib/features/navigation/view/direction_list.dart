...
class DirectionsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> allSteps = List<Map<String, dynamic>>.from(directions);
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                } else if (step['instructions'].toString().contains('Turn right')) {
                  icon = Icons.turn_right;
                } else if (isDestinationStep || index == directions.length - 1) {
                  icon = Icons.place;
                }
                ...
                return ListTile(
                  ...
                  title: Text(
                    ...
                    style: TextStyle(
                      fontWeight: (isCurrentStep || isDestinationStep) ? FontWeight.bold : FontWeight.normal,
                    ),
                  ),
