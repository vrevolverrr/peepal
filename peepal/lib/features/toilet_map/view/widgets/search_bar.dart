...
class ToiletSearchBar extends StatefulWidget {
  ...
  final Function(ToiletLocation)? onLocationSelected;
...
class _ToiletSearchBarState extends State<ToiletSearchBar> {
  ...
  List<ToiletLocation> _filteredLocations = [];
  ...
  void _filterLocations(String query) {
    ...
    final filtered = _dataService.searchLocations(query);
            ...
            child: Padding(
              ...
              child: SearchBar(
                ...
                hintStyle: const MaterialStatePropertyAll(TextStyle(
                    fontSize: 16.0, color: Color(0xFF5C5C5C))),
